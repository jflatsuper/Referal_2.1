...
@else
       ...
       @auth <div class="d-flex flex-column flex-shrink-0 bg-light vh-100" style="width: 4.5rem;">
    <a  href="{{ url('/') }}" class="d-block p-3 link-dark text-decoration-none" title="Icon-only" data-bs-toggle="tooltip" data-bs-placement="right">
    ...
    <div class="dropdown border-top">
      ...
      <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser3">
        ...
        <li><a class="dropdown-item" href="{{ route('logout') }}"
            ...
            @auth<div style="height:60px;background-color:lightblue">
          </div> @endauth
           <div style="padding:40px;background-color:grey"> @yield('content')</div>
          </div>
